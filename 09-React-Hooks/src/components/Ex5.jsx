                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    ...
                                    useEffect hook. It fits where, to prevent the user from seeing flickers of changes we can use useLayoutEffect.
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                            ...
                            <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 my-3" key={index}>
                                <div className="card shadow">
                                    <div className="card-header">
                                        <h5 className="text-center text-success">{user.id}. {user.name} </h5>
                                    </div>
